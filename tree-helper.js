...
function relationshipCheck(){
	...
	if ((r === 'father') && (g === 'f')) m = 'Mother cannot be female gender';
...
function showOptions(personId, obj){
	...
	{
		$('.modal-person .btn-add[data-relation="son"]').prop('disabled', true);
		$('.modal-person .btn-add[data-relation="daughter"]').prop('disabled', true);		
